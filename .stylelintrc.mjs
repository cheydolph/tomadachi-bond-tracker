...
export default {
  ...
  rules: {
    ...
    "selector-pseudo-element-no-unknown": [
      true,
      { ignorePseudoElements: ["webkit-scrollbar", "webkit-scrollbar-track", "webkit-scrollbar-thumb"] },
    ],
    ...
    "order/properties-order": [
      ...
      "align-self", "gap", "grid-template-columns", "grid-column",
      "grid-row",
      "float", "clear",
      ...
      "white-space", "writing-mode", "text-orientation",
      "color",
      // Visual
      ...
      // Misc
      "content", "resize", "appearance", "will-change",
    ],
    ...
    "function-no-unknown": [
      true,
      { ignoreFunctions: ["theme", "env", "max", "oklch"] },
    ],
