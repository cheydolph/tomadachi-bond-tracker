  ...
  if (names.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center px-4">
        ...
        <h3 className="text-lg font-semibold text-gray-500 mb-2 font-fredoka">
          No names yet!
        </h3>
  ...
  return (
    ...
    <div className="flex flex-col gap-4 pb-24">
      ...
      <div className="bg-white rounded-2xl p-3 shadow-sm border border-gray-100">
        <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2 px-1 font-fredoka">
          View bonds from:
        </p>
      ...
      {names.length < 2 ? (
        ...
        <div className="flex flex-col gap-2">
          ...
          {personBonds.length === 0 ? (
            ...
            personBonds.map(({ to, level, reverseLevel: _reverseLevel }) => {
  ...
  return (
    <button
      ...
      className={`
        ...
        ${isActive ? 'bg-rose-500 text-white shadow-sm' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}
      `}
    >
      {label}
    </button>
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide px-1 font-fredoka">
      {children}
    </p>
  )
}
