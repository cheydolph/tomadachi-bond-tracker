...
export const Route = createFileRoute('/privacy')({
  ...
  head: () => ({
    meta: [{ title: 'Privacy Policy — Tomadachi Bond Tracker' }],
  }),
})
    ...
    >
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <p className="text-xs">
            By using Tomadachi Bond Tracker, you confirm that you understand and
            agree to the Terms of Service below. If you do not agree to these
          ...
          <div className="space-y-6 text-sm mt-6 leading-relaxed">
            <section>
              ...
              <p>
                Tomadachi Bond Tracker does not collect, store, transmit, or
                sell any personal data to any third parties. The application
                runs entirely in your browser. Your data may be sent anonymously
                to self-hosted third-party services or trusted third-party tools
                used solely to keep the site functional.
              </p>
            </section>
